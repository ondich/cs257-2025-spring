...
cats = [{'name':'Emma', 'birth_year':1983, 'death_year':2003, 'description':'the boss'},
        ...
        {'name':'Digby', 'birth_year':2000, 'death_year':2018, 'description':'archetype of Cat'},
        {'name':'Scout', 'birth_year':2007, 'death_year':None, 'description':'accident-prone'},
        {'name':'Leo', 'birth_year':2022, 'death_year':None, 'description':'so busy'},
        {'name':'Lily', 'birth_year':2022, 'death_year':None, 'description':'too chill for you'}]
