...
There are many map-drawing libraries for Javascript. I spent some time hunting for them in 2020, and I found this one, Datamaps by Mark DiMarco, to be the easiest to use for drawing interactive US and World maps. The Datamaps project hasn't been maintained much in the last several years, so if I were embarking on a map-related project today, I'd seek out a more recent project with an active developer community. But I still like Datamaps a lot for the kinds of applications people write in CS257.
